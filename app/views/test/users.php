<?php $this->layout('layout1', ['title' => 'Users']) ?>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('app/views/test/img/demo/avatars/avatar-b.png'); background-size: cover;"></span>
                                </span>
