<?php $this->layout('layout1', ['title' => $title]) ?>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('app/views/test/img/demo/avatars/<?=$user['image_name'] ?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="/user_delete" class="dropdown-item" onclick="return confirm('are you sure?');">
