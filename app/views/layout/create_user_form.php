                ...
                <div id="panel-1" class="panel">
                    <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinputJob">Место работы</label>
                                    <input type="text" id="simpleinputJob" name="position" class="form-control">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinputTel">Номер телефона</label>
                                    <input type="text" id="simpleinputTel" name="phone" class="form-control">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinputAddress">Адрес</label>
                                    <input type="text" id="simpleinputAddress" name="address" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput1" name="email" class="form-control">
                                </div>
