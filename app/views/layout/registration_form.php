<?php $this->layout('templates/template_login', ['title' => $title]) ?>
    ...
    <div class="page-wrapper auth">
        <div class="page-inner bg-brand-gradient">
            <div class="page-content-wrapper bg-transparent m-0">
                    ...
                    <div class="d-flex align-items-center container p-0">
                        <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                            <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                                <img src="../app/views/layout/img/logo.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
                ...
                <div class="flex-1" style="background: url(../app/views/layout/img/svg/pattern-1.svg) no-repeat center bottom fixed; background-size: cover;">
                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="/registration" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="userpassword" class="form-control" name="password" placeholder="Пароль" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
